...
{
    TOCropViewController *cropController = [[TOCropViewController alloc] initWithCroppingStyle:self.croppingStyle isEnableDrawToCrop:true image:image];
...
- (void)didTapImageView
{
    ...
    TOCropViewController *cropController = [[TOCropViewController alloc] initWithCroppingStyle:self.croppingStyle isEnableDrawToCrop:true image:self.image];
    cropController.delegate = self;
